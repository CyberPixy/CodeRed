    ...
    while True:
        ...
        if choice == '1':
            ...
            try:
                ...
                print(f"Converted:{amount_input}{from_currency_input} is: {converted_amount[0]:.2f} {to_currency_input}, Todays'fx for {from_currency_input} is {converted_amount[1]}")
            ...
            try:
                ...
                print(f"The analysed sell {from_currency_input} buy EUR is {trend[0]}. Initial rate:{trend[1]}, Latest rate: {trend[2]}")
                print(f"Actual date:{trend[3]} FX Rate for {from_currency_input}/EUR: {trend[2]}"),
                print(f"FX Trend calculated based on prior dates to Actual is:{trend[0]}"),
            except ValueError as e:
                print(f"Error: {e}")
            except Exception as e:
                print(f"An error occurred: {e}")
